...
function Banner() {
	return (
		<div>
			<section className='dark:bg-gray-900 bg-teal-50 w-full dark:text-white text-emerald-950'>
				<div className='w-full px-4 py-32 lg:flex lg:h-screen lg:items-center'>
					<div className='mx-auto w-full  text-center'>
						...
						<div className='mt-8 flex flex-wrap justify-center gap-4'>
							...
							<a
								className='block w-full rounded border border-blue-600 px-12 py-3 text-sm font-medium dark:text-white  text-teal-700 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto'
								href='#'>
								Learn More
							</a>
						</div>
